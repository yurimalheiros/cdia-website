...
layout: page
title: Corpo Docente
subtitle: Conheça nossos professores e a coordenação do curso
---
...
<div class="card">
  <h3 class="card-title">Juliana Barros</h3>
  <span class="badge badge-accent">Secretária</span>
  <p class="card-text" style="margin-top: 1rem;">
    <strong>E-mail:</strong> julianabarros@ci.ufpb.br
  </p>
</div>
...
Os docentes do curso pertencem a vários departamentos da universidade segundo suas especialidades, mas a maioria está lotada no DCC (Departamento de Computação Científica).
